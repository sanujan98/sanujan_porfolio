...
const SkillsSection = () => {
  const technicalSkills = [
    ...
    { category: "Backend", skills: ["Node.js", "Express", "Python", "Django", "PHP", "Laravel"] },
    { category: "Database", skills: ["MongoDB", "PostgreSQL", "MySQL", "Redis", "Firebase"] },
    { category: "DevOps", skills: ["Docker", "AWS", "CI/CD", "GitHub Actions", "Netlify/Vercel"] },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {technicalSkills.map((skillGroup) => (
              <div key={skillGroup.category} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h4 className="text-xl font-bold mb-4 text-portfolio-blue">{skillGroup.category}</h4>
